...
var KTCardsWidget1 = {
    init: function () {
        ! function () {
            ...
            if (t) {
                var e = t.getAttribute("data-kt-chart-color"),
...
var KTChartsWidget12 = function () {
    ...
    return {
        init: function () {
            t("#kt_charts_widget_12_tab_1", "#kt_charts_widget_12_chart_1", [54, 42, 75, 110, 23, 87, 50], !0), t("#kt_charts_widget_12_tab_2", "#kt_charts_widget_12_chart_2", [25, 55, 35, 50, 45, 20, 31], !1), t("#kt_charts_widget_12_tab_3", "#kt_charts_widget_12_chart_3", [45, 15, 35, 70, 45, 50, 21], !1),
                function () {
...
var KTChartsWidget5 = {
    init: function () {
        ! function () {
            ...
            if (t) {
                var e = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
                    a = {
                        series: [{
...
var KTChartsWidget8 = function () {
    ...
    return {
        init: function () {
            t("#kt_chart_widget_8_week_toggle", "#kt_chart_widget_8_week_chart", [
                [
                    [100, 250, 30]
                ],
                [
            ...
            ], !1), t("#kt_chart_widget_8_month_toggle", "#kt_chart_widget_8_month_chart", [
                [
                    [125, 300, 40]
                ],
                [
...
var KTTablesWidget4 = function () {
    ...
    const r = () => {
        ...
        i = () => {
            const t = document.querySelectorAll('[data-kt-table-widget-4="expand_row"]'),
                e = [3, 1, 3, 1, 2, 1];
            t.forEach(((t, a) => {
            ...
            (t = document.querySelector("#kt_table_widget_4_table")) && ((() => {
                t.querySelectorAll("tbody tr").forEach((t => {
                    const e = t.querySelectorAll("td"),
                        a = moment(e[1].innerHTML, "DD MMM YYYY, LT").format();
    ...
    return {
        init: function () {
            (t = document.querySelector("#kt_table_widget_5_table")) && (t.querySelectorAll("tbody tr").forEach((t => {
                const e = t.querySelectorAll("td"),
                    a = moment(e[2].innerHTML, "MMM DD, YYYY").format();
        ...
        document.querySelectorAll('[data-kt-timeline-widget-1="tab"]').forEach((t => {
            t.addEventListener("shown.bs.tab", (e => {
                "#kt_timeline_widget_1_tab_week" === t.getAttribute("href") && (() => {
                    ...
                    var e = Date.now(),
                        a = t.getAttribute("data-kt-timeline-widget-1-image-root"),
                        r = new vis.DataSet([{
                            id: 1,
                            content: "Research",
                            order: 1
